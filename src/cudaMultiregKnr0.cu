//$Id: cudaMultiregKnr0.cu,v 1.4 2010/05/15 14:39:39 afs Exp $
//
// !!! Processing in mycudamath functions assumes column order for compatibility with R
//

#include "d_rngMars.cu"

namespace Kmars {

using namespace MM_rng;

__global__ void
cudaruniregNRK(float* d_betabar, float* tau, float* y, int nu, int nreg, int nobs, int m, int seed1, int seed2)
{
